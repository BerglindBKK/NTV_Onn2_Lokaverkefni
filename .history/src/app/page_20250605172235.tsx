				...
				<div className="parent-homescreen">
					...
					<div className="div4">
						...
						<div className="reviews">
							...
							<div className="reviewcard">
								<img src="assets/review2.png"></img>
								<div className="stars">
									<img src="assets/star.png"></img><img src="assets/star.png"></img><img src="assets/star.png"></img><img src="assets/star.png"></img><img src="assets/star.png"></img>
								</div>
								<div className="reviewtext">
									Tiny food and TIny calories. I only ate their cake for 3 months and, well.. look at me now!
								</div>
							</div>
							<div className="reviewcard">
								<img src="assets/review3.png"></img>
								<div className="stars">
									<img src="assets/star.png"></img></img><img src="assets/star.png"></img><img src="assets/star.png"></img>
							</div>
							<div className="reviewtext">
						...
						<div className="reviewcard">
							...
							<div className="reviewtext">
								OOoooooweeee, this sure is the tiniest tiny food I have ever seen. Looking forward to eat here again! Ooooweeee!
							</div>
						</div>
