...
const SelectDrink = () => {
    ...
    // Combine drink and found
    const combinedDrinks = [...drink, ...found];

    // Remove duplicates by idDrink (because some drinks might be in both arrays)
    ...
    // Now filter for selected drinks from the full combined list
                    ...
                    <div className="div5">
                        ...
                        {drink.length === 0 ? (
                            ...
                            <div className="grid-container">
                                {(found.length > 0 ? found : drink).map((im, idx) => (
                                    <div
                                        className={
                                            "grid-item" +
