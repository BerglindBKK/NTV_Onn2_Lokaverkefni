                                    ...
                                    >
                                        ...
                                        {hoveredDrinkId === im.idDrink && (
                                            <div className="grid-item-fact">
                                                {/* <p>{im.idDrink}</p> */}
                                                {/* <p>Cocktail Name</p><br></br> */}
                                                <p style={{ fontSize: "2rem" }}>{im.strDrink}</p>
                                                <p style={{ fontSize: "1rem" }}>{im.strAlcoholic}</p><br></br>
                                                <p><strong>Category:</strong>{im.strCategory}</p>
                                                <p><strong>Served in a:</strong> {im.strGlass}</p>

                                                <div><strong>Main ingredients:</strong>
