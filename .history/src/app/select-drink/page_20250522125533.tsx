...
const SelectDrink = () => {
    ...
    const fetchOrderByEmail = async (email: string) => {
        try {
            ...
            if (isOrder(order)) {
                // Now TypeScript knows `order` is a valid Order
                console.log("Valid order:", order);
            } else {
                console.error("Invalid order shape!", order);
            }
        }
        catch (err: any) {
                                    ...
                                    >
                                        ...
                                        {hoveredDrinkId === im.idDrink && (
                                            <div className="grid-item-fact">
                                                <p style={{ fontSize: "1.5rem", padding: "0.25rem" }}>{im.strDrink}</p>
                                                <p style={{ fontSize: "1rem", padding: "0.25rem" }}>{im.strAlcoholic}</p><br></br>
                                                ...
                                                <div style={{ textAlign: "center", width: "100%" }}><strong>Main ingredients:</strong>
                        ...
                        <div className="left">
                            ...
                            {selectedDrinks.length === 0 ? (
                                ...
                                selectedDrinks.map(d => (
                                    <p key={d.idDrink}>
                                        {/* Input field fyrir drink amount  */}
                                        <input
