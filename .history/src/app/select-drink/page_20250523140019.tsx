                ...
                <div className="parent-orderdish">
                                    ...
                                    >
                                        ...
                                        {hoveredDrinkId === im.idDrink && (
                                            <div className="grid-item-fact">
                                                ...
                                                <p style={{ fontSize: "1rem", padding: "0.5rem" }}>{im.strAlcoholic}</p><br></br>
                    ...
                    <div className="div2">
                        <div className="left">
                            ...
                            // At this point, selectedDateTime is guaranteed to be non-null

                            const updatedOrder: Order = {
                                ...order!,
                                date: selectedDateTime, // this is Date, matches string | Date
};
