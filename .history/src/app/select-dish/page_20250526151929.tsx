                ...
                <div className="parent-orderdish">
                    ...
                    <div className="div2">
                        <div className="left">
                            ...
                            <p>{dish?.strMeal}</p>
                            <p>Total Meal Price  =  ${mealPrice.toFixed(2)}</p><br></br>

                        </div >

                        <div className="lower">
                            <p className="centered">How many Tiny Mouths will we be serving?</p><br></br>
                            <div className="amount">
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        setDishAmount(prev => (prev + 1 > 10 ? prev + 1 : 10));
                                    }}>+</button>
                            </div>
                            <button
                                className="button"
