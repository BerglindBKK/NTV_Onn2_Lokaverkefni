...
const SelectDish = () => {
    ...
    const handleSelectDish = async () => {
        ...
        const updatedDish = {
            ...
            cuisine: dish.strArea || "Unknown", // fix typo here
            description: "",
        ...
        const updatedOrder: Order = {
            ...
            email: order.email,
            count: order.count,
            date: new Date(order.date), // keep as Date if your backend expects it
            dish: updatedDish,
            drinks: order.drinks || [], // ensure drinks is an array (empty or existing)
        };
