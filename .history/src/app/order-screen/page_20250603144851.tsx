...
const OrderScreen = () => {
    ...
    const handleSelectDate = async () => {
        ...
        //check if weekend (Sunday er 0, Saturday is 6)
        const day = selectedDate?.getDay();
        console.log("er helgi? day:", day);

        if (day === 0 || day === 6) {
            console.log("User picked a weekend date:", selectedDate);
            // Do something like show a warning
        } else {
            console.log("User picked a weekday:", selectedDate);
        }
        ...
        <div className="page-container">
            <main className="grid-wrapper">
                <div className="parent-orderdish">
                    <div className="div5">
                        <div className="timetable">
                            ...
                            <div className="datepicker-wrapper">
                                <div className="datepicker-scaled">
                                    <h2>Select a date:</h2>
                                    <DatePicker
                    ...
                    <div className="div2">
                        <div className="left div2-mobile-hidden">
