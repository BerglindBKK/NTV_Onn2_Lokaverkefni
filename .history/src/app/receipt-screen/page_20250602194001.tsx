...
const ReceiptScreen = () => {
    ...
    const handleDelete = async (email: string) => {
        ...
        setLoading(true);
        try {
            const deleted = await api.deleteOrderByEmail(email); // no need to encode here if api function encodes
            console.log("Delete response:", deleted);
            if (deleted && deleted.success && deleted.response) {
                alert("Order deleted");
                router.push("/");
            } else {
            ...
            <main className="grid-wrapper">
                <div className="parent-orderdish">
                    ...
                    <div className="div2">
                        ...
                        <div className="receipt-centered">
                            <div>
                                <button
                                    className="button"
                                    onClick={() => {
