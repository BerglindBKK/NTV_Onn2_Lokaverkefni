				...
				<div className="parent-homescreen">
					...
					<div className="div2-homescreen">
						<div>
							...
							<p className="div2-homescreen-p">Why don’t you come down to lil’bits, where the food is tiny. It looks like regular food, but really tuny. You put it in you mouth and eat it. Nothing gets stuck in your lips. It’s just tiny and tiny and fits, fits right in!</p>
