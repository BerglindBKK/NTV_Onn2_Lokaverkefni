		...
		<div className="page-container">
			...
			<main className="grid-wrapper">
				<div className="parent-homescreen">
					...
					<div className="div2">
						<div>
							<p className="justified">Is your mouth tiny and small?</p>
					...
					<div className="div3">
						<div>
							<label className="flex items-center space-x-2">
								...
								/>
								<span>Check to see Text 1</span>
							</label>

							<p className="mt-4">
								{isChecked ? "✅ Text 1 is shown (checked)" : "❌ Text 2 is shown (not checked)"}
							</p>

						</div>
						<p> Sign up for new and exciting tiny  interdimensional offers and newsletters, directly do your one dimensional inbox in your own dimension </p>
						{/* <p> Sign up for new and exciting tiny  interdimensional offers and newsletters, directly do your one dimensional inbox in your own dimension </p> */}
