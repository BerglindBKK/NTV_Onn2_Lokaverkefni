...
const Home = () => {
	...
	const [isExistingOrder, sestIsExistingOrder] = useState<string | null>(null);
		...
		<div className="page-container">
			...
			<main className="grid-wrapper">
				<div className="parent-homescreen">
					...
					<div className="div2">
						<div>
							<p className="justified">Hey, listen, Is your mouth tiny and small?</p>
							<p className="justified">Why don't you order from 'Little Bits' where the food is tiny?
							...
							<p className="justified">
								...
								Oh, s***! We got tiny people! Come and meet likemouthed people or get our
								tiny people to deliver to you!
							</p>
